...
- a **use context** with a **focus** of *Active immunization* (SNOMED CT `33879002`), so clients can tell immunization schedules apart from other PlanDefinitions on the server.
...
- the **date**, **publisher**, **approval date** and **effective period**, and any further **use contexts** (such as jurisdiction);
