...
The [diagnosis type CodeSystem](CodeSystem-diagnosis-type-cs.html) has grown from 12 to 22 codes, with `cancer-0003-0001` to `cancer-0003-0010` naming the document a cancer registration was established from: a medical record (outpatient card) or an extract from one, held by a branch of the national oncology and radiology centre, by another medical institution or by a private clinic; a record from the national centre for paediatric oncology, haematology and immunology, or from the national haematology centre; a notification from a branch, from another institution or from a regional or city medical association; a death certificate; and the civil registry office. They flow into the [diagnosis type value set](ValueSet-diagnosis-type-vs.html), which is bound (required) to the [diagnosis type extension](StructureDefinition-diagnosis-type.html) that [UZ Core Condition](StructureDefinition-uz-core-condition.html) carries.
