...
#form-download { border: 1px solid #c3d0d4; border-radius: 6px; background: #fff; color: #2a3d45; cursor: pointer; font: inherit; font-size: 0.9rem; padding: 6px 14px; }
#form-download:hover { background: #eaf1f3; }
...
<div id="form-controls">
  ...
  <button id="form-download" type="button">JSON</button>
</div>
