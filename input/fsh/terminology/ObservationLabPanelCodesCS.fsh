CodeSystem: ObservationLabPanelCodesCS
Id: observation-lab-panel-codes-cs
...
* insert OriginalCodeSystemDraft(observation-lab-panel-codes-cs)
/*
* ^property[0].code = #parent
* ^property[=].uri = "http://hl7.org/fhir/concept-properties#parent"
* ^property[=].type = #code 

* ^property[0].code = #panel
* ^property[=].description = "Panel code this analyte belongs to"
* ^property[=].type = #code 
*/
...
* #lab-E "Najasning mikroskopik tekshiruvi"
  ...
  * #lab-53 "Mushak tolalari: chiziqli"
    * ^designation[0].language = #ru
  ...
  * #lab-54 "Mushak tolalari: chiziqsiz"
    * ^designation[0].language = #ru
  ...
  * #lab-59 "Hazm bo'ladigan o'simlik tolasi"
    * ^designation[0].language = #ru
  ...
  * #lab-71 "Najasning Gram bo'yicha bo'yalgan holda mikroskopiyasi"
    * ^designation[0].language = #ru
  ...
  * #lab-72 "Najasning trixrom bo'yicha bo'yalgan holda mikroskopiyasi"
    * ^designation[0].language = #ru
  ...
  * #lab-73 "Najasning qorong'i maydon usuli bilan mikroskopiyasi"
    * ^designation[0].language = #ru
  ...
  * #lab-74 "Yorug'lik mikroskopiyasi orqali najasda aniqlangan gijja tuxumlari va parazitlar"
    * ^designation[0].language = #ru
...
* #lab-F "Siydikning makroskopik tekshiruvi"
  ...
  * #lab-89 "Epiteliy: buyrak epiteliyasi"
    * ^designation[0].language = #ru
  ...
  * #lab-91 "O'zgargan eritrotsitlar"
    * ^designation[0].language = #ru
...
* #lab-H "Biokimyoviy qon tahlili"
  ...
  * #lab-113 "Aspartataminotransferaza (AST)"
    * ^designation[0].language = #ru
  ...
  * #lab-114 "Laktatdegidrogenaza (LDH)"
    * ^designation[0].language = #ru
  ...
  * #lab-115 "Gammaglutamiltransferaza (GGT)"
    * ^designation[0].language = #ru
...
* #lab-I "Gormonal qon tahlili"
  ...
  * #lab-134 "PSA (prostata-spetsifik antigen)"
    * ^designation[0].language = #ru
...
* #lab-K "Balg'am tahlili"
  ...
  * #lab-173 "Atipik belgilarga ega hujayralar"
    * ^designation[0].language = #ru
...
* #lab-N "Serebrospinal suyuqlik (likvor) tekshiruvi"
  ...
  * #lab-207 "Araxnoidal endoteliy hujayralari"
    * ^designation[0].language = #ru
...
* #lab-O "Suyak iligi punktati tahlili"
  ...
  * #lab-220 "Segmentyadroli neytrofillar"
    * ^designation[0].language = #ru
  ...
  * #lab-231 "Polixromatofil eritroblastlar"
    * ^designation[0].language = #ru
  ...
  * #lab-232 "Oksifil eritroblastlar"
    * ^designation[0].language = #ru
  ...
  * #lab-233 "Polixromatofil normoblastlar"
    * ^designation[0].language = #ru
  ...
  * #lab-237 "Polixromatofil megaloblastlar"
    * ^designation[0].language = #ru
  ...
  * #lab-238 "Oksifil megaloblastlar"
    * ^designation[0].language = #ru
