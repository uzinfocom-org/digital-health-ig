...
* url = "https://terminology.dhp.uz/fhir/core/ConceptMap/lab-panel-to-loinc"
* name = "LabPanelsToLoinc"
* status = #draft
* experimental = false
* publisher = "Uzinfocom"

* group.source = Canonical(ObservationLabPanelCodesCS)
