...
* concept[+] = #test-0001-00019 "RDW-CV"
  * designation[0].language = #ru
...
* concept[+] = #test-0001-00020 "RDW-SD"
  * designation[0].language = #ru
...
* concept[+] = #test-0001-00027 "ECHT (eritrotsitlarning cho'kish tezligi)"
  * designation[0].language = #ru
...
* #test-0002-00002 "Kvik bo'yicha protrombin indeksi"
  ...
  * ^property[0].code = #parent
  * ^property[=].valueCode = #test-0002-00001
...
* #test-0003-00002 "Leykotsitlar"
  ...
  * ^property[0].code = #parent
  * ^property[=].valueCode = #test-0003-00001
...
* #test-0004-00002 "Leykotsitlar"
  ...
  * ^designation[=].value = "Leukocytes [Presence] in Genital specimen by Light microscopy"
  * ^property[0].code = #parent
  * ^property[=].valueCode = #test-0004-00001
...
* #test-0005-00002 "Mushak tolalari: chiziqli"
  ...
  * ^property[0].code = #parent
  * ^property[=].valueCode = #test-0005-00001
...
* #test-0006-00002 "Siydik hajmi"
  ...
  * ^property[0].code = #parent
  * ^property[=].valueCode = #test-0006-00001
...
* #test-0007-00002 "Epiteliy: yassi"
  ...
  * ^property[0].code = #parent
  * ^property[=].valueCode = #test-0007-00001
...
* #test-0008-00002 "Umumiy oqsil"
  ...
  * ^property[0].code = #parent
  * ^property[=].valueCode = #test-0008-00001
...
* #test-0009-00002 "T3 (triiodtironin)"
  ...
  * ^property[0].code = #parent
  * ^property[=].valueCode = #test-0009-00001
...
* #test-0010-00002 "Hajmi"
  ...
  * ^property[0].code = #parent
  * ^property[=].valueCode = #test-00010-00001
...
* #test-0011-00002 "Miqdori"
  ...
  * ^property[0].code = #parent
  * ^property[=].valueCode = #test-00011-00001
...
* #test-0012-00002 "Miqdori"
  ...
  * ^property[0].code = #parent
  * ^property[=].valueCode = #test-00012-00001
...
* #test-0013-00002 "Xlamidiya (IgG antitanalari)"
  ...
  * ^property[0].code = #parent
  * ^property[=].valueCode = #test-00013-00001
...
* #test-0014-00002 "Miqdori"
  ...
  * ^property[0].code = #parent
  * ^property[=].valueCode = #test-00014-00001
