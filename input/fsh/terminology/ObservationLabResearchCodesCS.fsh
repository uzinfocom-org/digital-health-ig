...
* ^property[0].description = "Parent panel code for laboratory analyte (custom grouping link)."
* ^property[0].type = #code

* #lab-0001-00001 "Umumiy qon tahlili"
...
* #lab-0001-00002 "WBC"
  ...
  * ^property[0].code = #parent
  * ^property[0].valueCode = #lab-0001-00001
* #lab-0001-00003 "Neu#"
  * ^designation[0].language = #ru
...
* #lab-0001-00026 "P-LCR"
  ...
  * ^property[0].code = #parent
  * ^property[0].valueCode = #lab-0001-00001
* #lab-0001-00027 "ECHT (eritrotsitlarning cho'kish tezligi)"
  * ^designation[0].language = #ru
  ...
  * ^property[0].code = #parent
  * ^property[0].valueCode = #lab-0001-00001
* #lab-0002-00001 "Qon koagulogrammasi (qon ivish ko'rsatkichlari)"
  * ^designation[0].language = #ru
  * ^designation[=].value = "Коагулограммы крови"
  * ^designation[+].language = #en
  * ^designation[=].value = "Coagulation panel"

* #lab-0002-00002 "Kvik bo'yicha protrombin indeksi"
  * ^designation[0].language = #ru
  ...
  * ^property[0].code = #parent
  * ^property[0].valueCode = #lab-0002-00001
  
* #lab-0002-00003 "Protrombin vaqti"
  * ^designation[0].language = #ru
...
* #lab-0002-00004 "Xalqaro normallashtirilgan nisbat (INR)"
  * ^designation[0].language = #ru
...
* #lab-0002-00005 "Trombolab"
  * ^designation[0].language = #ru
  * ^designation[=].value = "Тромботест"
  * ^designation[+].language = #en
  * ^designation[=].value = "Thrombolab [Interpretation] in Platelet poor plasma"
  * ^property[0].code = #parent
  * ^property[0].valueCode = #lab-0002-00001

* #lab-0002-00006 "Fibrinogen"
  * ^designation[0].language = #ru
...
* #lab-0002-00007 "Faollashtirilgan qisman tromboplastin vaqti"
  * ^designation[0].language = #ru
...
* #lab-0003-00001 "Sitologik tekshiruv (surtma)"
  * ^designation[0].language = #ru
...
* #lab-0003-00006 "Trichomonadalar"
  * ^designation[0].language = #ru
...
* #lab-0004-00001 "Najasning makroskopik tekshiruvi"
  * ^designation[0].language = #ru
  * ^designation[=].value = "Макроскопическое исследование кала"
  * ^designation[+].language = #en
  * ^designation[=].value = "Cytology study of genital specimen by Light microscopy"

* #lab-0004-00002 "Leykotsitlar"
  * ^designation[0].language = #ru
  * ^designation[=].value = "Лейкоциты"
  * ^designation[+].language = #en
  * ^designation[=].value = "Leukocytes [Presence] in Genital specimen by Light microscopy"
  * ^property[0].code = #parent
  * ^property[0].valueCode = #lab-0004-00001

* #lab-0004-00003 "Epitelial hujayralar"
  * ^designation[0].language = #ru
  * ^designation[=].value = "Эпителиалные клетки"
  * ^designation[+].language = #en
  * ^designation[=].value = "Epithelial cells [Presence] in Genital specimen by Light microscopy"
...
* #lab-0004-00006 "Trichomonadalar"
  * ^designation[0].language = #ru
  * ^designation[=].value = "Трихомонады"
  * ^designation[+].language = #en
  * ^designation[=].value = "Trichomonas vaginalis [Presence] in Genital specimen by Light microscopy"
...
* #lab-0005-00002 "Mushak tolalari: chiziqli"
  ...
  * ^property[0].code = #parent
  * ^property[0].valueCode = #lab-0005-00001

* #lab-0005-00003 "Mushak tolalari: chiziqsiz"
  * ^designation[0].language = #ru
...
* #lab-0005-00004 "Biriktiruvchi to'qima"
  * ^designation[0].language = #ru
...
* #lab-0005-00006 "Yog' kislotalari"
  * ^designation[0].language = #ru
...
* #lab-0005-00008 "Hazm bo'ladigan o'simlik tolasi"
  * ^designation[0].language = #ru
...
* #lab-0005-00016 "Eng sodda organizmlar (protozoylar)"
  * ^designation[0].language = #ru
...
* #lab-0005-00017 "Gijja tuxumlari"
  * ^designation[0].language = #ru
...
* #lab-0005-00018 "Xamirturush zamburug'lari"
  * ^designation[0].language = #ru
...
* #lab-0005-00019 "Najasning mikroskopik kuzatuvi (nam preparat)"
  * ^designation[0].language = #ru
...
* #lab-0005-00020 "Najasning Gram bo'yicha bo'yalgan holda mikroskopiyasi"
  * ^designation[0].language = #ru
...
* #lab-0005-00021 "Najasning trixrom bo'yicha bo'yalgan holda mikroskopiyasi"
  * ^designation[0].language = #ru
...
* #lab-0005-00022 "Najasning qorong'i maydon usuli bilan mikroskopiyasi"
  * ^designation[0].language = #ru
...
* #lab-0005-00023 "Yorug'lik mikroskopiyasi orqali najasda aniqlangan gijja tuxumlari va parazitlar"
  * ^designation[0].language = #ru
...
* #lab-0006-00004 "Siydikning tashqi ko'rinishi"
  * ^designation[0].language = #ru
...
* #lab-0006-00005 "Refraktometriya orqali siydikning solishtirma zichligi"
  * ^designation[0].language = #ru
...
* #lab-0006-00006 "Siydik pH darajasi"
  * ^designation[0].language = #ru
...
* #lab-0006-00007 "lab-tasma orqali siydikdagi oqsil miqdori"
  * ^designation[0].language = #ru
  * ^designation[=].value = "Белок"
  * ^designation[+].language = #en
  * ^designation[=].value = "Protein [Mass/volume] in Urine by lab strip"
  * ^property[0].code = #parent
  * ^property[0].valueCode = #lab-0006-00001

* #lab-0006-00008 "lab-tasma orqali siydikdagi glyukoza miqdori"
  * ^designation[0].language = #ru
  * ^designation[=].value = "Глюкоза"
  * ^designation[+].language = #en
  * ^designation[=].value = "Glucose [Mass/volume] in Urine by lab strip"
  * ^property[0].code = #parent
  * ^property[0].valueCode = #lab-0006-00001

* #lab-0006-00009 "lab-tasma orqali siydikdagi ketonlar miqdori"
  * ^designation[0].language = #ru
  * ^designation[=].value = "Кетоновые тела"
  * ^designation[+].language = #en
  * ^designation[=].value = "Ketones [Mass/volume] in Urine by lab strip"
  * ^property[0].code = #parent
  * ^property[0].valueCode = #lab-0006-00001

* #lab-0006-00010 "lab-tasma orqali siydikda gemoglobinning mavjudligi"
  * ^designation[0].language = #ru
  * ^designation[=].value = "Реакция на наличие крови"
  * ^designation[+].language = #en
  * ^designation[=].value = "Hemoglobin [Presence] in Urine by lab strip"
  * ^property[0].code = #parent
  * ^property[0].valueCode = #lab-0006-00001

* #lab-0006-00011 "lab-tasma orqali siydikda bilirubinning mavjudligi"
  * ^designation[0].language = #ru
  * ^designation[=].value = "Билирубин"
  * ^designation[+].language = #en
  * ^designation[=].value = "Bilirubin [Presence] in Urine by lab strip"
  * ^property[0].code = #parent
  * ^property[0].valueCode = #lab-0006-00001

* #lab-0006-00012 "lab-tasma orqali siydikda urobilinogening mavjudligi"
  * ^designation[0].language = #ru
  * ^designation[=].value = "Уробилиноген"
  * ^designation[+].language = #en
  * ^designation[=].value = "Urobilinogen [Presence] in Urine by lab strip"
  * ^property[0].code = #parent
  * ^property[0].valueCode = #lab-0006-00001

* #lab-0006-00013 "Siydikda o't kislotalarining mavjudligi"
  * ^designation[0].language = #ru
...
* #lab-0007-00001 "Siydikning mikroskopik tekshiruvi"
  * ^designation[0].language = #ru
...
* #lab-0007-00004 "Epiteliy: buyrak epiteliyasi"
  * ^designation[0].language = #ru
...
* #lab-0007-00006 "O'zgargan eritrotsitlar"
  * ^designation[0].language = #ru
...
* #lab-0007-00007 "O'zgarmagan eritrotsitlar"
  * ^designation[0].language = #ru
...
* #lab-0007-00008 "Silindrlar: gialinli"
  * ^designation[0].language = #ru
...
* #lab-0007-00009 "Silindrlar: mumsimon"
  * ^designation[0].language = #ru
...
* #lab-0007-00010 "Silindrlar: donador"
  * ^designation[0].language = #ru
...
* #lab-0007-00011 "Silindrlar: eritrotsitar"
  * ^designation[0].language = #ru
...
* #lab-0007-00012 "Silindrlar: leykotsitar"
  * ^designation[0].language = #ru
...
* #lab-0007-00013 "Silindrlar: epitelial"
  * ^designation[0].language = #ru
...
* #lab-0008-00004 "Xolesterin (umumiy)"
  * ^designation[0].language = #ru
...
* #lab-0008-00005 "Triglitseridlar"
  * ^designation[0].language = #ru
...
* #lab-0008-00009 "Umumiy bilirubin"
  * ^designation[0].language = #ru
...
* #lab-0008-00010 "To'g'ri (bog'langan) bilirubin"
  * ^designation[0].language = #ru
...
* #lab-0008-00011 "Bilvosita (erkin) bilirubin"
  * ^designation[0].language = #ru
...
* #lab-0008-00012 "Alaninaminotransferaza (ALT)"
  * ^designation[0].language = #ru
...
* #lab-0008-00013 "Aspartataminotransferaza (AST)"
  * ^designation[0].language = #ru
...
* #lab-0008-00014 "Laktatdegidrogenaza (LDH)"
  * ^designation[0].language = #ru
...
* #lab-0008-00015 "Gammaglutamiltransferaza (GGT)"
  * ^designation[0].language = #ru
...
* #lab-0008-00017 "Ishqoriy fosfataza"
  * ^designation[0].language = #ru
...
* #lab-0009-00004 "TTG (tireotrop gormon)"
  * ^designation[0].language = #ru
...
* #lab-0009-00006 "labosteron"
  * ^designation[0].language = #ru
  * ^designation[=].value = "Тестостерон"
  * ^designation[+].language = #en
  * ^designation[=].value = "labosterone [Mass/volume] in Serum or Plasma"
  * ^property[0].code = #parent
  * ^property[0].valueCode = #lab-0009-00001

* #lab-0009-00007 "Kortizol"
  * ^designation[0].language = #ru
...
* #lab-0009-00009 "LG (luteinlashtiruvchi gormon)"
  * ^designation[0].language = #ru
...
* #lab-0009-00010 "FSG (follikulni rag'batlantiruvchi gormon)"
  * ^designation[0].language = #ru
...
* #lab-0009-00012 "PSA (prostata-spetsifik antigen)"
  * ^designation[0].language = #ru
...
* #lab-0010-00006 "Kislotaliligi (pH)"
  * ^designation[0].language = #ru
...
* #lab-0010-00008 "1 ml dagi spermatozoidlar soni"
  * ^designation[0].language = #ru
...
* #lab-0010-00009 "Umumiy hajmdagi spermatozoidlar soni"
  * ^designation[0].language = #ru
...
* #lab-0010-00010 "Harakatchanlik — faol"
  * ^designation[0].language = #ru
...
* #lab-0010-00011 "Harakatchanlik — sust"
  * ^designation[0].language = #ru
...
* #lab-0010-00012 "Harakatchanlik — harakatsiz"
  * ^designation[0].language = #ru
...
* #lab-0010-00013 "Tirik spermatozoidlar"
  * ^designation[0].language = #ru
...
* #lab-0010-00014 "Spermatozoidlarning patologik shakllari"
  * ^designation[0].language = #ru
...
* #lab-0010-00015 "Spermatogenez epiteliyasi"
  * ^designation[0].language = #ru
...
* #lab-0010-00017 "Letsitin donachalari"
  * ^designation[0].language = #ru
...
* #lab-0010-00018 "Agglyutinatsiya"
  * ^designation[0].language = #ru
...
* #lab-0010-00020 "Limon kislotasi"
  * ^designation[0].language = #ru
...
* #lab-0011-00005 "Xususiyati (tavsifi)"
  * ^designation[0].language = #ru
...
* #lab-0011-00007 "Konsistensiyasi"
  * ^designation[0].language = #ru
...
* #lab-0011-00009 "Alveolyar makrofaglar"
  * ^designation[0].language = #ru
...
* #lab-0011-00013 "Elastik tolalar"
  * ^designation[0].language = #ru
...
* #lab-0011-00014 "Ohaklangan (toshga o'xshash) zarrachalar"
  * ^designation[0].language = #ru
...
* #lab-0011-00015 "Sil mikobakteriyalari"
  * ^designation[0].language = #ru
...
* #lab-0011-00019 "Kurshman spirallari"
  * ^designation[0].language = #ru
...
* #lab-0011-00020 "Sharko–Leyden kristallari"
  * ^designation[0].language = #ru
...
* #lab-0011-00021 "Atipik belgilarga ega hujayralar"
  * ^designation[0].language = #ru
...
* #lab-0012-00005 "Konsistensiyasi"
  * ^designation[0].language = #ru
  * ^designation[=].value = "Консистенция"
  * ^designation[+].language = #en
...
* #lab-0012-00010 "Letsitin donachalari"
  * ^designation[0].language = #ru
  * ^designation[=].value = "Лецитиновые зёрна"
  * ^designation[+].language = #en
...
* #lab-0012-00011 "Amiloid tanachalar"
  * ^designation[0].language = #ru
...
* #lab-0012-00012 "Spermatozoidlar"
  * ^designation[0].language = #ru
...
* #lab-0012-00013 "Trichomonadalar"
  * ^designation[0].language = #ru
  * ^designation[=].value = "Трихомонады"
  * ^designation[+].language = #en
...
* #lab-0012-00016 "Atipik belgilarga ega hujayralar"
  * ^designation[0].language = #ru
  * ^designation[=].value = "Клетки с атипичными признаками"
  * ^designation[+].language = #en
...
* #lab-0013-00004 "Sitomegalovirus (IgG antitanalari)"
  * ^designation[0].language = #ru
...
* #lab-0013-00005 "Oddiy gerpes virusi (IgG antitanalari)"
  * ^designation[0].language = #ru
...
* #lab-0014-00004 "Sentrifugatsiyadan oldingi ksantoxromiya"
  * ^designation[0].language = #ru
...
* #lab-0014-00005 "Sentrifugatsiyadan keyingi shaffofligi"
  * ^designation[0].language = #ru
...
* #lab-0014-00007 "Pandi reaksiyasi"
  * ^designation[0].language = #ru
  * ^designation[=].value = "Реакция Панди"
  * ^designation[+].language = #en
  * ^designation[=].value = "Pandy lab [Interpretation] in Cerebrospinal fluid"
  * ^property[0].code = #parent
  * ^property[0].valueCode = #lab-0014-00001

* #lab-0014-00008 "Limfotsitlar"
  * ^designation[0].language = #ru
...
* #lab-0014-00012 "O'zgargan hujayralar"
  * ^designation[0].language = #ru
...
* #lab-0014-00014 "Plazmatik hujayralar"
  * ^designation[0].language = #ru
...
* #lab-0014-00015 "Araxnoidal endoteliy hujayralari"
  * ^designation[0].language = #ru
...
* #lab-0014-00016 "Ependima hujayralari"
  * ^designation[0].language = #ru
...
* #lab-0014-00017 "Donador sharlar"
  * ^designation[0].language = #ru
...
* #lab-0015-00001 "Suyak iligi punktati tahlili"
  * ^designation[0].language = #ru
...
* #lab-0015-00004 "Yetilmagan blastlar"
  * ^designation[0].language = #ru
...
* #lab-0015-00006 "Promiyelotsitlar"
  * ^designation[0].language = #ru
...
* #lab-0015-00008 "Metamiyelotsitlar"
  * ^designation[0].language = #ru
...
* #lab-0015-00009 "Tayoqchasimon yadroli neytrofillar"
  * ^designation[0].language = #ru
...
* #lab-0015-00010 "Segmentyadroli neytrofillar"
  * ^designation[0].language = #ru
...
* #lab-0015-00012 "Prolimfotsitlar"
  * ^designation[0].language = #ru
...
* #lab-0015-00017 "Leyko-eritroblastik nisbat"
  * ^designation[0].language = #ru
...
* #lab-0015-00018 "Neytrofillar yetilish indeksi"
  * ^designation[0].language = #ru
...
* #lab-0015-00019 "Proeritroblastlar"
  * ^designation[0].language = #ru
...
* #lab-0015-00020 "Bazofil eritroblastlar"
  * ^designation[0].language = #ru
...
* #lab-0015-00021 "Polixromatofil eritroblastlar"
  * ^designation[0].language = #ru
...
* #lab-0015-00022 "Oksifil eritroblastlar"
  * ^designation[0].language = #ru
...
* #lab-0015-00023 "Polixromatofil normoblastlar"
  * ^designation[0].language = #ru
...
* #lab-0015-00024 "Oksifil normoblastlar"
  * ^designation[0].language = #ru
...
* #lab-0015-00025 "Promegaloblastlar"
  * ^designation[0].language = #ru
...
* #lab-0015-00026 "Bazofil megaloblastlar"
  * ^designation[0].language = #ru
...
* #lab-0015-00027 "Polixromatofil megaloblastlar"
  * ^designation[0].language = #ru
...
* #lab-0015-00028 "Oksifil megaloblastlar"
  * ^designation[0].language = #ru
...
* #lab-0015-00029 "Megakarioblastlar"
  * ^designation[0].language = #ru
...
* #lab-0015-00030 "Promegakariotsitlar"
  * ^designation[0].language = #ru
...
* #lab-0015-00031 "Megakariotsitlar"
  * ^designation[0].language = #ru
...
* #lab-0015-00032 "Retikulyar hujayralar"
  * ^designation[0].language = #ru
...
* #lab-0015-00034 "Proplazmotsitlar"
  * ^designation[0].language = #ru
...
* #lab-0015-00035 "Plazmatik hujayralar"
  * ^designation[0].language = #ru
  * ^designation[=].value = "Плазматические клетки"
  * ^designation[+].language = #en
...
* #lab-0015-00036 "Granulopoez hujayralarining mitozi"
  * ^designation[0].language = #ru
...
* #lab-0015-00037 "Eritropoez hujayralarining mitozi"
  * ^designation[0].language = #ru
...
* #lab-0015-00038 "Eritroblastlar va normoblastlar sitoplazmasining yetilish indeksi"
  * ^designation[0].language = #ru
