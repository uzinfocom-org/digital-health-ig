...
// The nesting below expresses the panel/analyte hierarchy, but nesting lives on the CodeSystem and
// is lost once this system is included in a ValueSet - expansion.contains is flat. These properties
// carry the hierarchy into the expansion instead: a client expanding observation-codes-vs can ask
// for them with $expand?property=kind&property=parent and so tell panels from analytes.
* ^property[0].code = #kind
* ^property[=].uri = "https://terminology.dhp.uz/fhir/core/CodeSystem/lab-pan-cs#kind"
* ^property[=].description = "Whether the concept is a laboratory panel or an individual analyte reported within a panel"
// #string, not #code: property.type = code means a code defined in *this* code system, which
// panel/analyte are not. Only #parent below qualifies for #code, its values being panel codes.
* ^property[=].type = #string
* ^property[+].code = #parent
* ^property[=].uri = "http://hl7.org/fhir/concept-properties#parent"
* ^property[=].description = "The panel this analyte belongs to"
* ^property[=].type = #code
...
* #lab-pan-A "Siydikning makrosopik tekshiruvi"
  ...
  * #lab-pan-1 "Miqdori"
    ...
    * ^property[0].code = #kind
    * ^property[=].valueString = "analyte"
    * ^property[+].code = #parent
    * ^property[=].valueCode = #lab-pan-A
...
// Distinct from lab-pan-E: this panel is the automated haematology analyser CBC (absolute
// differential counts, RDW-SD, P-LCC/P-LCR, IMG#, NRBC), whereas lab-pan-E is the CBC with
// manual differential and light microscopy. The qualifiers keep the two tellable apart -
// before, both read "CBC panel" in every language.
* #lab-pan-CC "Umumiy qon tahlili (gematologik analizator)"
  * ^designation[0].language = #ru
  * ^designation[=].value = "Общий анализ крови (гематологический анализатор)"
  * ^designation[+].language = #en
  * ^designation[=].value = "CBC panel - Blood by Automated count"
  * ^property[0].code = #kind
  * ^property[=].valueString = "panel"
