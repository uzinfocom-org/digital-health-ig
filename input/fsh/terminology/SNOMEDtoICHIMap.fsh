Instance: SNOMEDtoICHIProceduresMap
...
* url = "https://terminology.uz/fhir/ConceptMap/snomed-to-ichi-procedures"
* version = "1.0.0"
...
* targetScopeUri = "https://mizar.ictpu.uz/api/v1/fhir/CodeSystem/ichi"

// Wrist Joint Procedures -> ICHI MFJ.DN.AA
* group[+].source = "http://snomed.info/sct"
* group[=].target = "https://mizar.ictpu.uz/api/v1/fhir/CodeSystem/ichi"
...
// LVAD Procedures -> ICHI HBA.DN.AA
* group[+].source = "http://snomed.info/sct"
* group[=].target = "https://mizar.ictpu.uz/api/v1/fhir/CodeSystem/ichi"
