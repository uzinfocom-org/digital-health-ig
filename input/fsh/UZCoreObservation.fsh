...
* component[0].code = observation-lab-research-codes-cs#1 "Leukocytes [#/volume] in Blood by Automated count"
* component[=].valueQuantity = 6.2 '10*9/L' "10^9/L"
* component[+].code = observation-lab-research-codes-cs#2 "Neutrophils [#/volume] in Blood by Automated count"
* component[=].valueQuantity = 3.7 '10*9/L' "10^9/L"
* component[+].code = observation-lab-research-codes-cs#3 "Lymphocytes [#/volume] in Blood by Automated count"
* component[=].valueQuantity = 2.0 '10*9/L' "10^9/L"
* component[+].code = observation-lab-research-codes-cs#4 "Monocytes [#/volume] in Blood by Automated count"
* component[=].valueQuantity = 0.4 '10*9/L' "10^9/L"
* component[+].code = observation-lab-research-codes-cs#5 "Eosinophils [#/volume] in Blood by Automated count"
* component[=].valueQuantity = 0.1 '10*9/L' "10^9/L"
* component[+].code = observation-lab-research-codes-cs#6 "Basophils [#/volume] in Blood by Automated count"
* component[=].valueQuantity = 0.0 '10*9/L' "10^9/L"
* component[+].code = observation-lab-research-codes-cs#7 "Neutrophils/100 leukocytes in Blood by Automated count"
* component[=].valueQuantity = 60 '%' "%"
* component[+].code = observation-lab-research-codes-cs#8 "Lymphocytes/100 leukocytes in Blood by Automated count"
* component[=].valueQuantity = 32 '%' "%"
* component[+].code = observation-lab-research-codes-cs#9 "Monocytes/100 leukocytes in Blood by Automated count"
* component[=].valueQuantity = 6 '%' "%"
* component[+].code = observation-lab-research-codes-cs#10 "Eosinophils/100 leukocytes in Blood by Automated count"
* component[=].valueQuantity = 2 '%' "%"
* component[+].code = observation-lab-research-codes-cs#11 "Basophils/100 leukocytes in Blood by Automated count"
* component[=].valueQuantity = 0 '%' "%"
* component[+].code = observation-lab-research-codes-cs#12 "Erythrocytes [#/volume] in Blood by Automated count"
* component[=].valueQuantity = 4.7 '10*12/L' "10^12/L"
* component[+].code = observation-lab-research-codes-cs#13 "Hemoglobin [Mass/volume] in Blood"
* component[=].valueQuantity = 145 'g/L' "g/L"
* component[+].code = observation-lab-research-codes-cs#14 "Hematocrit [Volume Fraction] of Blood by Automated count"
* component[=].valueQuantity = 43 '%' "%"
* component[+].code = observation-lab-research-codes-cs#15 "MCV [Entitic volume] by Automated count"
* component[=].valueQuantity = 91 'fL' "fL"
* component[+].code = observation-lab-research-codes-cs#16 "MCH [Entitic mass] by Automated count"
* component[=].valueQuantity = 30.9 'pg' "pg"
* component[+].code = observation-lab-research-codes-cs#17 "MCHC [Mass/volume] by Automated count"
* component[=].valueQuantity = 338 'g/L' "g/L"
* component[+].code = observation-lab-research-codes-cs#18 "Erythrocyte distribution width (RDW-CV) [Ratio] by Automated count"
* component[=].valueQuantity = 13.1 '%' "%"
* component[+].code = observation-lab-research-codes-cs#19 "Erythrocyte distribution width (RDW-SD) [Entitic volume] by Automated count"
* component[=].valueQuantity = 42 'fL' "fL"
* component[+].code = observation-lab-research-codes-cs#20 "Platelets [#/volume] in Blood by Automated count"
* component[=].valueQuantity = 250 '10*9/L' "10^9/L"
* component[+].code = observation-lab-research-codes-cs#21 "Mean platelet volume [Entitic volume] in Blood by Automated count"
* component[=].valueQuantity = 9.8 'fL' "fL"
* component[+].code = observation-lab-research-codes-cs#22 "Platelet distribution width [Entitic volume] in Blood by Automated count"
* component[=].valueQuantity = 12.1 'fL' "fL"
* component[+].code = observation-lab-research-codes-cs#23 "Plateletcrit [Volume Fraction] of Blood by Automated count"
* component[=].valueQuantity = 0.24 '%' "%"
* component[+].code = observation-lab-research-codes-cs#24 "Platelet large cell count [#/volume] in Blood by Automated count"
* component[=].valueQuantity = 60 '10*9/L' "10^9/L"
* component[+].code = observation-lab-research-codes-cs#25 "Platelet large cell ratio [#] in Blood by Automated count"
* component[=].valueQuantity = 24 '%' "%"
* component[+].code = observation-lab-research-codes-cs#26 "Erythrocyte sedimentation rate (ESR) by Westergren method"
