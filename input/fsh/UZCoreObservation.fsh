...
* code = $loinc#57021-8 "CBC W Auto Differential panel"
* subject = Reference(Patient/example-salim)
...
* component[0].code = $loinc#6690-2 "Leukocytes [#/volume] in Blood by Automated count"
...
* component[+].code = $loinc#742-7 "Monocytes [#/volume] in Blood by Automated count"
...
* component[+].code = $loinc#770-8 "Neutrophils/100 leukocytes in Blood by Automated count"
* component[=].valueQuantity = 60 '%' "%"
* component[+].code = $loinc#736-9 "Lymphocytes/100 leukocytes in Blood by Automated count"
* component[=].valueQuantity = 32 '%' "%"
* component[+].code = $loinc#5905-5 "Monocytes/100 leukocytes in Blood by Automated count"
* component[=].valueQuantity = 6 '%' "%"
* component[+].code = $loinc#713-8 "Eosinophils/100 leukocytes in Blood by Automated count"
* component[=].valueQuantity = 2 '%' "%"
* component[+].code = $loinc#706-2 "Basophils/100 leukocytes in Blood by Automated count"
...
* component[+].code = $loinc#718-7 "Hemoglobin [Mass/volume] in Blood"
...
* component[+].code = $loinc#787-2 "MCV [Entitic volume] by Automated count"
...
* component[+].code = $loinc#786-4 "MCHC [Mass/volume] by Automated count"
* component[=].valueQuantity = 338 'g/L' "g/L"
* component[+].code = $loinc#788-0 "Erythrocyte distribution width (RDW-CV) [Ratio] by Automated count"
* component[=].valueQuantity = 13.1 '%' "%"
* component[+].code = $loinc#21000-5 "Erythrocyte distribution width (RDW-SD) [Entitic volume] by Automated count"
...
* component[+].code = $loinc#32623-1 "Mean platelet volume [Entitic volume] in Blood by Automated count"
...
* component[+].code = $loinc#777-9 "Plateletcrit [Volume Fraction] of Blood by Automated count"
* component[=].valueQuantity = 0.24 '%' "%"
* component[+].code = $loinc#13056-7 "Platelet large cell count [#/volume] in Blood by Automated count"
* component[=].valueQuantity = 60 '10*9/L' "10^9/L"
* component[+].code = $loinc#51637-7 "Platelet large cell ratio [#] in Blood by Automated count"
* component[=].valueQuantity = 24 '%' "%"
* component[+].code = $loinc#4537-7 "Erythrocyte sedimentation rate (ESR) by Westergren method"
