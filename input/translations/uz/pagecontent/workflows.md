...
- Bemorning roziligini hisobga oling. O'qish so'rovlari bemorning [Consent](StructureDefinition-uz-core-consent.html) resursiga bog'liq; rad etilgan so'rovga `403` qaytariladi. Har bir kirish holati [AuditEvent](StructureDefinition-uz-core-audit-event.html) resursida qayd etiladi.
