...
Laboratoriya tahlillari va panellarini buyurtma qilish uchun UZ Core ServiceRequest Laboratory profili qo'shildi, jumladan [to'lov turi](ValueSet-payment-type-vs.html) va [so'rov holati](ValueSet-service-request-status-vs.html) terminologiyasi bilan.
