...
Если пациент не может быть немедленно идентифицирован (например, пациент без сознания, который не может предоставить документы, удостоверяющие личность), платформа предусматривает два типа идентификаторов. По возможности рекомендуется использовать временный номер медицинской карты в рамках организации.
...
Данный идентификатор используется только в случае, если медицинская организация, принявшая неустановленного пациента, неизвестна либо ИНН организации недоступен. По возможности рекомендуется использовать временный номер медицинской карты в рамках организации.
