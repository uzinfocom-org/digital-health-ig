...
[CodeSystem типов диагноза](CodeSystem-diagnosis-type-cs.html) вырос с 12 до 22 кодов: `cancer-0003-0001` - `cancer-0003-0010` называют документ, на основании которого онкологический диагноз поставлен на учёт - историю болезни (амбулаторную карту) или выписку из неё филиала РСНПМЦОиР, другого медицинского учреждения либо частной клиники; историю болезни РНПМЦ детской онкологии, гематологии и иммунологии или РСНПМЦ гематологии; извещение филиала, другого учреждения или РМО/ГМО; свидетельство о смерти; ЗАГС. Они попадают в [ValueSet типов диагноза](ValueSet-diagnosis-type-vs.html), привязанный (required) к [расширению типа диагноза](StructureDefinition-diagnosis-type.html), которое несёт [UZ Core Condition](StructureDefinition-uz-core-condition.html).
