...
Encounter.diagnosis теперь ссылается на профили UZ Core Condition вместо базового Condition.

Encounter.serviceType теперь ссылается на UZCoreHealthcareService вместо базового набора значений FHIR.
