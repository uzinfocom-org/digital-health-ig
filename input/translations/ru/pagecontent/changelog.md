...
### Версия 0.3.0
Добавлены UZ Core профили для [Encounter](StructureDefinition-UZCoreEncounter.html), [EpisodeOfCare](StructureDefinition-UZCoreEpisodeOfCare.html) и [Observation](StructureDefinition-uz-core-laboratory-observation.html).
